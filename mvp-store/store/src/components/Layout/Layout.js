    ...
    render() {
        return (
                <div className="container">
                    <div class="notification">
                    <strong>MVP Store</strong> | Your one-stop shop for all your construction, interiors, real-estate and landscaping <Link to="/add">Add</Link>
                        <div class="tabs is-centered">
                            <ul>
                                <li class="is-active"><a>Lumber</a></li>
